...
<html>
  ...
  <body >
    ...
    <table>
      <tr>
        <td width="120px"><strong>Khách hàng:</strong></td> <td>ghjkl</td>
        <td><strong></td>
      </tr>
      <tr>
        <td width="120px"><strong>Địa chỉ:</strong></td> <td>rtyujik</td>
        <td></td>
      </tr>
      <tr>
        <td width="120px"><strong>Điện thoại:</strong></td> <td> dfghjk</td>
        <td></td>
      </tr>
      <tr>
        <td width="120px"><strong>Email:</strong></td> <td> fghjkl;</td>
        <td></td>
      </tr>
    </table><br><br>
    <table cellpadding="3px" style="border:thin solid;" >
      ...
      <tbody>
            ...
            <tr >
              <td style="border:thin blue solid;border-style:dashed;">gh</td>
              <td style="border:thin blue solid;border-style:dashed;">
                  rtyuio
              </td>
              <td style="border:thin blue solid;border-style:dashed;">jklrtyu</td>
              <td style="border:thin blue solid;border-style:dashed;">
              etyui
              </td>
              
              <td style="border:thin blue solid;border-style:dashed;" >yujkl</td>
          </tr>
    ...
    <table class="sumary-table">
      <tr>
        ...
        <td style="border:thin blue solid;border-style:dashed;" width="152px"> vnđ</td>
      </tr>
      <tr>
        <td width="500px">Tổng giá trị</td>
        <td width="152px" style="border:thin blue solid;border-style:dashed;">èt</td>
      </tr>
    </table><br>
